...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a >未通过视频列表</a></li>
			
		</ul>
		
		<form class="well form-search" method="post" action="<?php echo U('Video/nopassindex');?>">
			排序：
				...
				<tbody>
					...
					<?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr>
						...
						<td align="center">
							...
							|
							<a href="<?php echo U('Video/edit',array('id'=>$vo['id'],'from'=>'nopassindex'));?>" >编辑</a>
							 <?php if($vo['isdel'] == '0'): ?>|
							
							<a href="javascript:void (0)" onclick="commentlists(<?php echo ($vo['id']); ?>)" >评论列表</a><?php endif; ?>
							 |
			...
			$.ajax({
				...
				success:function(data){
					...
					layer.msg("删除成功",{icon: 1,time:1000},function(){
						layer.closeAll();
						location.href='/index.php?g=Admin&m=Video&a=nopassindex&p='+p;
					});
				},
				error:function(e){
