...
<body>
	<div class="wrap">
		...
		<form class="well form-search" method="post" action="<?php echo U('Advert/lowervideo');?>">
				...
				<tbody>
					...
					<?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr>
						...
						<td align="center">	
							...
							|
							<a href="<?php echo U('Advert/edit',array('id'=>$vo['id'],'from'=>'lower'));?>" >编辑</a>
							|
							 <?php if($vo['isdel'] == '1'): ?><a href="<?php echo U('Advert/set_shangjia',array('id'=>$vo['id']));?>" class="js-ajax-dialog-btn" data-msg="您确定要将该视频上架吗？">上架</a>
							 |<?php endif; ?>
			...
			$.ajax({
				...
				success:function(data){
					...
					layer.msg("删除成功",{icon: 1,time:1000},function(){
						layer.closeAll();
						location.href='/index.php?g=Admin&m=Advert&a=lowervideo&p='+p;
					});
				},
				error:function(e){
