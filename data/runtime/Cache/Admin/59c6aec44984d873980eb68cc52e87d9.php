...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			...
			<li><a href="<?php echo U('Report/classify_add');?>">添加</a></li>
		</ul>
		<form class="well form-search" method="post" action="<?php echo U('Report/classify');?>">

			关键字： 
			<input type="text" name="keyword" style="width: 200px;" value="<?php echo ($formget["keyword"]); ?>" placeholder="请输入分类名称">
			<input type="submit" class="btn btn-primary" value="搜索">
		</form>
		<form method="post" class="js-ajax-form" action="<?php echo U('Report/classify_listorders');?>">
			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr>
						...
						<td align="center">
							<a href="<?php echo U('Report/classify_edit',array('id'=>$vo['id']));?>" >编辑</a>|
							
							<a href="<?php echo U('Report/classify_del',array('id'=>$vo['id']));?>" class="js-ajax-dialog-btn" data-msg="您确定要删除吗？">删除</a>
